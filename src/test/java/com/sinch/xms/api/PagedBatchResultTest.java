...
public class PagedBatchResultTest {
  ...
  public void canSerializeJsonWithEmptyBatches() throws Exception {
    PagedBatchResult input = new PagedBatchResult.Builder().page(0).size(0).totalSize(0).build();
  ...
  public void canDeserializeJsonWithEmptyBatches() throws Exception {
    PagedBatchResult expected = new PagedBatchResult.Builder().page(0).size(0).totalSize(0).build();

    String input = json.writeValueAsString(expected);

    PagedBatchResult actual = json.readValue(input, PagedBatchResult.class);
