...
public final class TestUtils {
  ...
  /**
   * Field used by, e.g., {@link #freshServicePlanId()} and {@link #freshBatchId()} to generate
   * unique values.
   */
  ...
  /**
   * Hamcrest matcher that verifies that two strings describe the same JSON content.
   *
   * @param expected a JSON encoded string
