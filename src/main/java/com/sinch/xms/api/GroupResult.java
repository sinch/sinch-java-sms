...
/**
 * Objects of this class contain information about a group. The information includes creation time
 * stamp and group identifier and it must therefore be populated by XMS, which is the source of such
 * information.
 */
@Value.Immutable
@ValueStylePackage
