...
public abstract class ApiError {
  ...
  /**
   * A collection of known error codes. The REST API reserves the right to introduce new error codes
   * as need arise so these may not be exhaustive.
   */
  public static final class Code {
    ...
    /** The format of a parameter is invalid. For example if an MSISDN is not properly formatted. */
    public static final String SYNTAX_INVALID_PARAMETER_FORMAT = "syntax_invalid_parameter_format";

    /**
     * The request body doesn’t fulfill all of the constraints set by the API. For example missing
     * required parameters or too many elements in a list.
     */
