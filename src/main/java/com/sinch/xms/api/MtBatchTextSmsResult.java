...
/**
 * Objects of this class contain information about a textual SMS batch. The information includes the
 * text message body, the batch identifier, the creation time, and so on.
 */
@Value.Immutable
@ValueStylePackage
...
public abstract class MtBatchTextSmsResult extends MtBatchSmsResult {
  ...
  /**
   * The message text or template. If this describes a template then {@link #parameters()} describes
