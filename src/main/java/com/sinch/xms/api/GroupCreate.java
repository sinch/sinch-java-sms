...
/**
 * A class describing parameters available during group creation. Groups can be used within XMS to
 * organize message recipients and easily send batch messages to all members but referring to the
 * group identifier as message recipient.
 */
@Value.Immutable
@ValueStylePackage
...
public abstract class GroupCreate {
  ...
  /**
   * Describes how this group is auto updated through user interaction. Is <code>null</code> if the
   * group is not auto updated.
   *
